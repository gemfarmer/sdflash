...
// // void UpdateFirmware::checkCardForUpdates() {
...
// void UpdateFirmware::updateFromString(String str, size_t fileSize) {
...
// void UpdateFirmware::updateFromFile(File &firmwareFile) {
//   size_t fileSize = firmwareFile.fileSize();
